...
async function iniciarAtividade() {
    try {
        ...
        const botaoAnimais = document.querySelectorAll('.opcao-alt');
        ...
        botaoAnimais.forEach(botaoAnimal => {
            botaoAnimal.addEventListener('click', () => {
                ...
                if (animaisSelecionados.length === 2) {
                    ...
                    animaisSelecionados = []; // Limpa os animais selecionados após enviar os dados
                }
            });
        });
...
function redirecionarUsuario() {
    ...
    if (proximoCapitulo == "false") {
        ...
        window.location.href = '../views/gatoRato-1.html'
    }
}
