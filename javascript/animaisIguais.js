...
createImage(400, 10, '../imagens/animais/borboleta.png', 1, 100, 100);
createImage(window.innerWidth / 2 - 50, 10, '../imagens/animais/gato.png', 2, 100, 100);
createImage(window.innerWidth - 500, 10, '../imagens/animais/macaco/macaco.png', 3, 100, 100);
createImage(400, window.innerHeight - 400, '../imagens/animais/macaco/macaco.png', 4, 100, 100);
createImage(window.innerWidth / 2 - 30, window.innerHeight - 400, '../imagens/animais/borboleta.png', 5, 100, 100);
createImage(window.innerWidth - 500, window.innerHeight - 400, '../imagens/animais/gato.png', 6, 100, 100);
