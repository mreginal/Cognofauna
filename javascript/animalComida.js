...
createImage(400, 10, '../imagens/animais/cachorro.png', 1, 100, 100);
createImage(window.innerWidth / 2 - 50, 10, '../imagens/animais/macaco/macaco.png', 2, 100, 100);
createImage(window.innerWidth - 500, 10, '../imagens/animais/coelho.png', 3, 100, 100);
createImage(400, window.innerHeight - 400, '../imagens/animais/cenoura.png', 4, 100, 100);
createImage(window.innerWidth / 2 - 30, window.innerHeight - 400, '../imagens/animais/osso.png', 5, 100, 100);
createImage(window.innerWidth - 500, window.innerHeight - 400, '../imagens/animais/banana.png', 6, 100, 100);
